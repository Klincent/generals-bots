...
static Observation board(){
 Observation o;o.turn=300;o.type.assign(441,1);o.owner.assign(441,1);o.army.assign(441,1);
...
int main(){
 setenv("V35_PICKER_GATE","1",1);setenv("V35_EDGE_PICKER_THRESHOLD","8",1);setenv("V36_EDGE_PICKER_MIN_EFFICIENCY","2.0",1);
 // Separate small edge packets must not be falsely treated as one dense bounded sweep.
 ...
 // A single sparse packet that cannot justify the bounded route is rejected on efficiency.
