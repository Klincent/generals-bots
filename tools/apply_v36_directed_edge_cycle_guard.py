...
# Current branch already has a temporary 4-cell revisit guard. Replace it with
# the exact rule requested: allow one backtrack, block only repetition of the
# same directed edge within the previous four moves.
